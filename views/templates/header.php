...
<head>
    ...
    <title><?php echo TITLE . ' - ' . $data['title']; ?></title> <!--titulo de panel administrativo viene de config app config.php-->
</head>
            ...
            <ul class="metismenu" id="menu">
                <li>
                    <a href="javascript:;">
                        ...
                        <div class="menu-title">Tablero</div> <!--Menu tablero-->
                    </a>
                </li>
                <li>
